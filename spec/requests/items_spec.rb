...
RSpec.describe 'Items API' do
	...
	describe 'POST /todos/:todo_id/items' do
		let(:valid_attributes) { { name: 'Visit Paris', done: false }.to_json }
	...
	describe 'PUT /todos/:todo_id/items' do
		let(:attributes) { { name: 'Visit Italy' }.to_json }

		before { put "/todos/#{todo_id}/items/#{id}", params: attributes, headers: headers }
